...
depth=13
for penalty in 2.1 2.2 2.3 2.4 2.5 2.6 2.7 2.8 2.9 3.0
do
    $BASE --dataset ls_dep:${depth}_num:2x_sparse:0.1 --lam_shrink 1e-2 --btree_depth ${depth} --btree_remove 0.20 --btree_manual_penalty ${penalty} &
done



#depth:ratio:penalty
# { 11: {0.05: 2.4, 0.1:2.5, 0.2:2.5}, 12:{0.05:2.9, 0.1:2.3, 0.2:2.4}, 13:{0.05:2.9, 0.1:2.2, 0.2:3.0}